      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.colorContainer}>
            {COLOR_INFO.map((grupo, i) => (
              <View key={i} style={styles.column}>
                <Text style={styles.colorCategory}>{grupo.categoria}</Text>
          ...
          <View style={styles.markSection}>
            ...
            <Text style={styles.markSubtitle}>
              Cada marca puede mostrarse en celeste (realizado) o rojo (a
              realizar)
            </Text>
            ...
            <View style={styles.markGrid}>
              {MARK_INFO.map((item, i) => (
                <View key={i} style={styles.markItem}>
                  <View style={styles.markExamples}>
                    <View style={styles.markBadgeBlue}>
                      <Text
                        style={{
                          ...styles.markTextBlue,
                          fontSize: item.inicial === "TC" ? 7 : 10
                        }}
                      >
                        {item.inicial}
                      </Text>
                  ...
                  <View style={styles.markTextContainer}>
                    <Text style={styles.markMainText}>
                      <Text style={{ fontWeight: "bold" }}>
                        {item.inicial}
                      </Text>
                      : {item.descripcion}
                    ...
                    <Text style={styles.markSecondaryText}>
