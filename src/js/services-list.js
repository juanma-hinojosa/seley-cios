...
export const infoClinics = [
  ...
  },
  {
    ...
    p: "Podemos continuar el tratamiento de otros consultorios sin ningun problema",
...
export const reviewList = [
  ...
  },
  {
    id: 3,
    name: "Sofia Moreno",
    p: "Mi gran salvadora!! Los comentarios no mienten, ella es un amor y el consultorio muy lindo y limpio👏🏼 Gracias por solucionar mi problema, por tu paciencia y la amabilidad de darme un sobre turno cuando más lo necesitaba🫂",
  },
  {
    id: 4,
    name: "Ivanna Coronel",
  ...
  },
  {
    id: 5,
    name: "Marina Postare",
    p: "Concurrí al consultorio con mi nene de 4 años. La atención fue muy buena ya desde el primer llamado para gestionar el turno, era algo que requería de cierta urgencia así que rápidamente me agendaron un sobreturno. Al llegar fueron super amables y cálidas ya desde la señorita de recepción como la Dra. Quién le explicó a mi nene paso a paso lo que iba realizando y le otorgó seguridad y tranquilidad en todo momento. Volvemos pronto para continuar el tratamiento y sin dudas los recomendamos.. Muchas gracias :)",
  },
];
